...
public class FullNodeList extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2328090890699229577L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"FullNodeList\",\"namespace\":\"com.eqchains.rpc.avro\",\"fields\":[{\"name\":\"cookie\",\"type\":{\"type\":\"record\",\"name\":\"Cookie\",\"fields\":[{\"name\":\"ip\",\"type\":\"string\"},{\"name\":\"version\",\"type\":\"string\"}]}},{\"name\":\"fullNodeList\",\"type\":\"bytes\"}]}");
   ...
   */
  public FullNodeList(com.eqchains.rpc.avro.Cookie cookie, java.nio.ByteBuffer fullNodeList) {
    this.cookie = cookie;
   ...
   */
  public static com.eqchains.rpc.avro.FullNodeList.Builder newBuilder() {
    return new com.eqchains.rpc.avro.FullNodeList.Builder();
  }
   ...
   * @return A new FullNodeList RecordBuilder
   */
  public static com.eqchains.rpc.avro.FullNodeList.Builder newBuilder(com.eqchains.rpc.avro.FullNodeList.Builder other) {
    return new com.eqchains.rpc.avro.FullNodeList.Builder(other);
  }
   ...
   * @return A new FullNodeList RecordBuilder
   */
  public static com.eqchains.rpc.avro.FullNodeList.Builder newBuilder(com.eqchains.rpc.avro.FullNodeList other) {
    return new com.eqchains.rpc.avro.FullNodeList.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FullNodeList>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.eqchains.rpc.avro.FullNodeList.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.eqchains.rpc.avro.FullNodeList other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.cookie)) {
        this.cookie = data().deepCopy(fields()[0].schema(), other.cookie);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqchains.rpc.avro.FullNodeList.Builder setCookie(com.eqchains.rpc.avro.Cookie value) {
     ...
     * @return This builder.
     */
    public com.eqchains.rpc.avro.FullNodeList.Builder setCookieBuilder(com.eqchains.rpc.avro.Cookie.Builder value) {
      clearCookie();
      cookieBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqchains.rpc.avro.FullNodeList.Builder clearCookie() {
      cookie = null;
      cookieBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqchains.rpc.avro.FullNodeList.Builder setFullNodeList(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqchains.rpc.avro.FullNodeList.Builder clearFullNodeList() {
      fullNodeList = null;
