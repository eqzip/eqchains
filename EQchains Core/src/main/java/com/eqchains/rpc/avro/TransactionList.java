...
public class TransactionList extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4067394263617187754L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TransactionList\",\"namespace\":\"com.eqchains.rpc.avro\",\"fields\":[{\"name\":\"cookie\",\"type\":{\"type\":\"record\",\"name\":\"Cookie\",\"fields\":[{\"name\":\"ip\",\"type\":\"string\"},{\"name\":\"version\",\"type\":\"string\"}]}},{\"name\":\"transactionList\",\"type\":\"bytes\"}]}");
   ...
   */
  public TransactionList(com.eqchains.rpc.avro.Cookie cookie, java.nio.ByteBuffer transactionList) {
    this.cookie = cookie;
   ...
   */
  public static com.eqchains.rpc.avro.TransactionList.Builder newBuilder() {
    return new com.eqchains.rpc.avro.TransactionList.Builder();
  }
   ...
   * @return A new TransactionList RecordBuilder
   */
  public static com.eqchains.rpc.avro.TransactionList.Builder newBuilder(com.eqchains.rpc.avro.TransactionList.Builder other) {
    return new com.eqchains.rpc.avro.TransactionList.Builder(other);
  }
   ...
   * @return A new TransactionList RecordBuilder
   */
  public static com.eqchains.rpc.avro.TransactionList.Builder newBuilder(com.eqchains.rpc.avro.TransactionList other) {
    return new com.eqchains.rpc.avro.TransactionList.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TransactionList>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.eqchains.rpc.avro.TransactionList.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.eqchains.rpc.avro.TransactionList other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.cookie)) {
        this.cookie = data().deepCopy(fields()[0].schema(), other.cookie);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqchains.rpc.avro.TransactionList.Builder setCookie(com.eqchains.rpc.avro.Cookie value) {
     ...
     * @return This builder.
     */
    public com.eqchains.rpc.avro.TransactionList.Builder setCookieBuilder(com.eqchains.rpc.avro.Cookie.Builder value) {
      clearCookie();
      cookieBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqchains.rpc.avro.TransactionList.Builder clearCookie() {
      cookie = null;
      cookieBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqchains.rpc.avro.TransactionList.Builder setTransactionList(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqchains.rpc.avro.TransactionList.Builder clearTransactionList() {
