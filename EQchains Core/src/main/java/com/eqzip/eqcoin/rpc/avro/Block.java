...
public class Block extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Block(com.eqzip.eqcoin.rpc.avro.Cookie cookie, java.nio.ByteBuffer block) {
    this.cookie = cookie;
    this.block = block;
  }
   ...
   */
  public static com.eqzip.eqcoin.rpc.avro.Block.Builder newBuilder() {
    return new com.eqzip.eqcoin.rpc.avro.Block.Builder();
  }
   ...
   * @return A new Block RecordBuilder
   */
  public static com.eqzip.eqcoin.rpc.avro.Block.Builder newBuilder(com.eqzip.eqcoin.rpc.avro.Block.Builder other) {
    return new com.eqzip.eqcoin.rpc.avro.Block.Builder(other);
  }
   ...
   * @return A new Block RecordBuilder
   */
  public static com.eqzip.eqcoin.rpc.avro.Block.Builder newBuilder(com.eqzip.eqcoin.rpc.avro.Block other) {
    return new com.eqzip.eqcoin.rpc.avro.Block.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Block>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.eqzip.eqcoin.rpc.avro.Block.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.eqzip.eqcoin.rpc.avro.Block other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.cookie)) {
        this.cookie = data().deepCopy(fields()[0].schema(), other.cookie);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqzip.eqcoin.rpc.avro.Block.Builder setCookie(com.eqzip.eqcoin.rpc.avro.Cookie value) {
     ...
     * @return This builder.
     */
    public com.eqzip.eqcoin.rpc.avro.Block.Builder setCookieBuilder(com.eqzip.eqcoin.rpc.avro.Cookie.Builder value) {
      clearCookie();
      cookieBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqzip.eqcoin.rpc.avro.Block.Builder clearCookie() {
      cookie = null;
      cookieBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqzip.eqcoin.rpc.avro.Block.Builder setBlock(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqzip.eqcoin.rpc.avro.Block.Builder clearBlock() {
      block = null;
