...
public class Transaction extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4562862981704801906L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Transaction\",\"namespace\":\"com.eqzip.eqcoin.rpc.avro\",\"fields\":[{\"name\":\"cookie\",\"type\":{\"type\":\"record\",\"name\":\"Cookie\",\"fields\":[{\"name\":\"ip\",\"type\":\"string\"},{\"name\":\"version\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":\"bytes\"}]}");
   ...
   */
  public Transaction(com.eqzip.eqcoin.rpc.avro.Cookie cookie, java.nio.ByteBuffer data) {
    this.cookie = cookie;
    this.data = data;
  }
   ...
   */
  public static com.eqzip.eqcoin.rpc.avro.Transaction.Builder newBuilder() {
    return new com.eqzip.eqcoin.rpc.avro.Transaction.Builder();
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.eqzip.eqcoin.rpc.avro.Transaction.Builder newBuilder(com.eqzip.eqcoin.rpc.avro.Transaction.Builder other) {
    return new com.eqzip.eqcoin.rpc.avro.Transaction.Builder(other);
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.eqzip.eqcoin.rpc.avro.Transaction.Builder newBuilder(com.eqzip.eqcoin.rpc.avro.Transaction other) {
    return new com.eqzip.eqcoin.rpc.avro.Transaction.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Transaction>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.eqzip.eqcoin.rpc.avro.Transaction.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.eqzip.eqcoin.rpc.avro.Transaction other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.cookie)) {
        this.cookie = data().deepCopy(fields()[0].schema(), other.cookie);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqzip.eqcoin.rpc.avro.Transaction.Builder setCookie(com.eqzip.eqcoin.rpc.avro.Cookie value) {
     ...
     * @return This builder.
     */
    public com.eqzip.eqcoin.rpc.avro.Transaction.Builder setCookieBuilder(com.eqzip.eqcoin.rpc.avro.Cookie.Builder value) {
      clearCookie();
      cookieBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqzip.eqcoin.rpc.avro.Transaction.Builder clearCookie() {
      cookie = null;
      cookieBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqzip.eqcoin.rpc.avro.Transaction.Builder setData(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eqzip.eqcoin.rpc.avro.Transaction.Builder clearData() {
      data = null;
